...
-- form = forms.newform(500, 700, "Fitness")
-- maxFitnessLabel = forms.label(form, "Max Fitness: " .. math.floor(pool.maxFitness), 5, 8)
-- showNetwork = forms.checkbox(form, "Show Map", 5, 100)
-- showMutationRates = forms.checkbox(form, "Show M-Rates", 5, 200)
-- restartButton = forms.button(form, "Restart", initializePool, 5, 300)
-- saveButton = forms.button(form, "Save", savePool, 5, 400)
-- loadButton = forms.button(form, "Load", loadPool, 80, 400)
-- saveLoadFile = forms.textbox(form, Filename .. ".pool", 170, 25, nil, 5, 500)
-- saveLoadLabel = forms.label(form, "Save/Load:", 5, 450)
...
while true do
	...
	fitness = fitness + playGame(fitness, species, genome, "SMB1-1.State")
	fitness = fitness + playGame(fitness, species, genome, "SMB1-2.State")
	fitness = fitness + playGame(fitness, species, genome, "SMB1-3.State")
